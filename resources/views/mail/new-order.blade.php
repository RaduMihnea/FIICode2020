                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td align="left"
                                                    ...
                                                    <h3 style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#faae39;">
                                                        Hello, {{$mail_data['seller_name']}}</h3></td>
                                            </tr>
                                            <tr style="border-collapse:collapse;">
                                                <td align="left"
                                                    ...
                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;">
                                                        {{$mail_data['buyer_name']}} is interested in buying
                                                        your products:</p></td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="left"
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0"
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td class="es-m-p20b" width="530" align="left"
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td align="center"
                                                    ...
                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:23px;color:#777777;">
                                                        <span
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td width="530" valign="top" align="center" style="padding:0;Margin:0;">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td align="left"
                                                    style="padding:0;Margin:0;padding-top:5px;"><p
                                                        ...
                                                        You must choose to accept or deny the order. Until
                                                        you have chosen, the above products remain blocked.
                                                        Follow the below link for more details:</p></td>
                                            </tr>
                                            <tr style="border-collapse:collapse;">
                                                <td align="center"
                                                    ...
                                                    <span class="es-button-border es-button-border-4"
                                                          style="border-style:solid;border-color:transparent;background:#FAAE39;border-width:0px;display:inline-block;border-radius:5px;width:auto;"><a
                                                            href="{{env('REACT_APP_UTL')}}orders/{{$mail_data['id']}}" class="es-button es-button-3"
                                                            target="_blank"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td align="left"
                                                    style="padding:0;Margin:0;padding-top:40px;"><h3
