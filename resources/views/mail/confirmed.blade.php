        ...
        <tr style="border-collapse:collapse;">
            <td valign="top" style="padding:0;Margin:0;">
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="center" style="padding:0;Margin:0;">
                            <table class="es-content-body"
                                   ...
                                   width="610" cellspacing="0" cellpadding="0" align="center">
                                <tr style="border-collapse:collapse;">
                                    <td align="left"
                ...
                <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="center" style="padding:0;Margin:0;">
                            <table class="es-content-body" width="610" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                   align="center"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left"
                                                                ...
                                                                <h3 style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#FAAE39;">
                                                                    Order no. {{$order_id}} confirmed</h3></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td width="540" align="left" style="padding:0;Margin:0;">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:15px;"><h4
                                                                    style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;color:#FAAE39;">
                                                                    {{$product['title']}}</h4></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#777777;">
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="center" style="padding:0;Margin:0;">
                            <table class="es-content-body" width="610" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-top:5px;"><p
                                                                    ...
                                                                    The above order has been confirmed. Below, you have
                                                                    {{$user['name']}}'s contact information. From now
                                                                    on, Piazeta takes no responsability in the course of
                                                                    this negotiation. However, we reserve our right to
                                                                    choose our future customers in the event of a
                                                                    dispute. Please act respectfully. Should the deal
                                                                    fall apart, the seller must report it on our website
                                                                    or the product will be considered
                                                                    sold.&nbsp;<br><br>Contact Information:</p>
                                                                <ul>
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px;background-image:url(https://edqpsd.stripocdn.email/content/guids/CABINET_3298ab460a5df6a3e0eecc62d229ac13/images/10831585821107406.jpg);background-position:center top;background-repeat:no-repeat;background-color:#130D09;"
                                        bgcolor="#130d09" align="left"
                                        background="https://edqpsd.stripocdn.email/content/guids/CABINET_3298ab460a5df6a3e0eecc62d229ac13/images/10831585821107406.jpg">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                            <tr style="border-collapse:collapse;">
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-top:10px;"><p
                                                                    ...
                                                                    Want to continue the retro-style of this deal?
                                                                    Communicate via letters!<br>Follow the link below
                                                                    and send a letter to your negotiation partner.<br>
                                                                </p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td align="left"
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                            <tr style="border-collapse:collapse;">
                                                <td class="es-m-p20b" width="540" align="left"
                ...
                <table cellpadding="0" cellspacing="0" class="es-content" align="center"
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="center" style="padding:0;Margin:0;">
                            <table class="es-content-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#079CDD;border-bottom:10px solid #079CDD;"
                                   width="610" cellspacing="0" cellpadding="0" bgcolor="#079cdd" align="center">
                                <tr style="border-collapse:collapse;">
                                    <td align="left" style="padding:0;Margin:0;">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                            <tr style="border-collapse:collapse;">
                                                <td class="es-m-p20b" width="610" align="left"
                                                    style="padding:0;Margin:0;">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                           role="presentation"
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                                    ...
                                                                    <tr class="links-images-top"
                                                                        ...
                                                                        <td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:35px;padding-bottom:30px;border:0;"
                                                                            ...
                                                                            align="center"><a target="_blank"
                                                                                              ...
                                                                                              href=""><img
                                                                                    src="https://edqpsd.stripocdn.email/content/guids/CABINET_3298ab460a5df6a3e0eecc62d229ac13/images/45461585821288706.png"
                                                                                    alt title height="27"
                                                                                    align="absmiddle"
                                                                        ...
                                                                        <td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:35px;padding-bottom:30px;border:0;"
                                                                            ...
                                                                            align="center"><a target="_blank"
                                                                                              style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;text-decoration:none;display:block;color:#FFFFFF;"
                                                                                              href=""><img
                                                                                    src="https://edqpsd.stripocdn.email/content/guids/CABINET_3298ab460a5df6a3e0eecc62d229ac13/images/62161585821323717.png"
                                                                                    alt title height="27"
                                                                                    align="absmiddle"
                                                                                    style="display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-bottom:5px;"><br></a>
                                                                        </td>
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-bottom:35px;"><p
                                                                    ...
                                                                    <b>Aleea Florilor nr. 33, 700458<br>Iasi,
                                                                        Romania</b><br></p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td esdev-links-color="#777777" align="left"
                                                                ...
                                                                style="padding:0;Margin:0;padding-bottom:5px;"><p
                                                                    ...
                                                                    address, please ignore this email.</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
